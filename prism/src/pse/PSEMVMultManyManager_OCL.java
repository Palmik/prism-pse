...
public class PSEMVMultManyManager_OCL implements PSEMultManyManager<PSEMVMultMany_OCL>
{
	...
	@Override
	final public void update(int matId, PSEMVMultMany_OCL mult)
	{
		mult.update(matId, model.getCreateData_MV_CSR(modelSubset, modelSubsetComplement));
	}

	@Override
	final public PSEMVMultMany_OCL create(int matCnt, final double weight[], double weightDef, int weightOff)
	{
		...
		PSEMVMultMany_OCL mult = new PSEMVMultMany_OCL(multOpts, multTopo, matCnt, weight, weightDef, weightOff);
